    ...
    <div>
        ...
        <div class="grid grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <input type="date" value="11th June, 2023" class="w-full border border-gray-300 rounded-md px-3 py-2"
               />
          </div>
          <div>
            <label class="block text-gray-700 font-semibold mb-2">To: </label>
            <input type="date" value="11th June, 2024" class="w-full border border-gray-300 rounded-md px-3 py-2"
               />
          </div>
        </div>
        <textarea
